...
class App < Sinatra::Base
  ...
  get '/' do
    "Welcome to Sinatra Sessions! In this , we will be learning about the general principles behind a sessions cookie. In order to proceed, let's go to the '/first_exercise' path."
  end
